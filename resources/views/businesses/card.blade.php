<div class="card flex flex-col" style="height: 200px;">
	<h3 class="font-normal text-xl mb-3 py-3 -ml-5 border-l-4 border-green-600 pl-3">
		<div class="flex justify-between">
			...
			<div class="flex justify-end">
				<a href="{{ $business->path().'/edit' }}" class="text-default hover:no-underline hover:text-blue-500">
					Edit
				</a>
			</div>
		</div>
	...
	<div>
		@if (isset($business->description) && strlen($business->description) > 60)
			{{ substr($business->description, 0, 57) ."..." }}
		@elseif (isset($business->description) && strlen($business->description) <= 60)
