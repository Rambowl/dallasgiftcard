...
@section('content')
	...
	<div class="flex justify-center w-full">
		<div class="flex flex-col bg-gray-300 border border-gray-500 p-4 w-1/3">
			...
			<div class="control mb-4">
				<label for="address_2" class="flex flex-col text-xl mb-2">Address Line 1</label>
				<input id="address_2" name="address1" type="text" class="border border-gray-500 rounded p-1 w-full" value="{{ old('address_2') }}">
			...
			<div class="control mb-4">
				...
				<div class="flex">
					<input name="city" type="text" class ="border border-gray-500 rounded p-1 mr-2 w-1/3" value="{{ old('city') }}">
					<input name="state" type="text" class ="border border-gray-500 rounded p-1 mr-2 w-1/3" value="{{ old('state') }}">
					<input name="zip_code" type="text" class ="border border-gray-500 rounded p-1 mr-2 w-1/3" value="{{ old('zip_code') }}">
				</div>
				@error('city')
